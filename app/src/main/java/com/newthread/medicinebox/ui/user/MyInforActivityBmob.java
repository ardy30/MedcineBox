 ...
 */
public class MyInforActivityBmob extends SwipeBackActivity {
    ...
    private void UpLoadImg(){
        ...
        if (FileUtils.fileIsExists(ConsUtils.path)){
            file.uploadblock(this, new UploadFileListener() {
                @Override
                public void onSuccess() {
                    System.out.println(file.getFileUrl(MyInforActivityBmob.this));
                    imgPath= file.getFileUrl(MyInforActivityBmob.this);
                    UpLoadUser();
                }
                @Override
                public void onFailure(int i, String s) {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                case ConsUtils.SET_INFORMATION_DONE:
                    ...
                    sp.saveCurrentUser(account, NickName.getText().toString(), Age.getText().toString(), true,"");
        ...
        AlertDialog alertDialog=new AlertDialog.Builder(this)
                ...
                .setItems(items, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        switch (which) {
                            case 0:
                                Crop.pickImage(MyInforActivityBmob.this);
                                dialog.dismiss();
                                break;
                            case 1:
